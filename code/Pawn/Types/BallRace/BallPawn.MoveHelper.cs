...
public struct BallMoveHelper
{
	...
	public Trace Trace;
	public ModelEntity Ball;

	public BallMoveHelper( Vector3 position, Vector3 velocity, ModelEntity ball ) : this()
	{
		Ball = ball;
		Velocity = velocity;
		Position = position;
	...
	public float TryMove( float timestep )
	{
		...
		if ( bumpForce > 350f && hitSurface != null && !silentSurfaces.Contains( hitSurface.ResourceName ) )
		{
			...
			//PredictionSound.World( Game.LocalClient, sound, hitPos );
		}
