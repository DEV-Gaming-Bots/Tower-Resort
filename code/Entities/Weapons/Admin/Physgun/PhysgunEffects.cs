...
public partial class PhysGun
{
	...
	protected virtual void UpdateEffects()
	{
		...
		if ( Beam == null )
		{
			Beam = Particles.Create( "particles/weapon/physgun/physgun_beam.vpcf", tr.EndPosition );
		}
		...
		else
		{
			...
			if ( EndNoHit == null )
				EndNoHit = Particles.Create( "particles/weapon/physgun/physgun_end_nohit.vpcf", lastBeamPos );
